...
public static class LocalizationManager
{
    ...
    private static readonly Dictionary<string, string[]> table = new Dictionary<string, string[]>
    {
        ...
        { "CAT_ALLEY_DOCK", new[] { "ALLEY DOCK", "ALLEY DOCK", "ALLEY DOCK", "ALLEY DOCK" } },
        { "CAT_ANGLE_BACK", new[] { "ANGLE BACK", "ANGLE BACK", "ANGLE BACK", "ANGLE BACK" } },
        { "CAT_FACILITY", new[] { "FACILITY", "FACILITY", "FACILITY", "FACILITY" } },
        { "CAT_PARALLEL", new[] { "PARALLEL PARKING", "PARALLEL PARKING", "PARALLEL PARKING", "PARALLEL PARKING" } },
        { "CAT_REST_AREA", new[] { "REST AREA", "REST AREA", "REST AREA", "REST AREA" } },
        { "CAT_TRUCK_STOP", new[] { "TRUCK STOP", "TRUCK STOP", "TRUCK STOP", "TRUCK STOP" } },
        { "CAT_OTHER", new[] { "OTHER MAPS", "OTHER MAPS", "OTHER MAPS", "OTHER MAPS" } },
